...
import be.kuleuven.hotelrestservice.data.auth.request.LoginRequest;
import be.kuleuven.hotelrestservice.data.auth.request.SignupRequest;
import be.kuleuven.hotelrestservice.data.auth.response.JwtResponse;
import be.kuleuven.hotelrestservice.data.auth.response.MessageResponse;
...
import be.kuleuven.hotelrestservice.repository.RoleRepository;
