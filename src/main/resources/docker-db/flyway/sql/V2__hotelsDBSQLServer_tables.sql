...
(
    ...
    type            NVARCHAR(25) NOT NULL CHECK (type IN('Economy', 'Standard',
                                                        'Deluxe', 'Family',
                                                        'Suite', 'Executive')),
...
(
    ...
    status              NVARCHAR(25) NOT NULL CHECK (status IN ('BOOKING_STATUS_CONFIRMED',
...
(
    id                  BIGINT IDENTITY(1,1) NOT NULL,
    type                NVARCHAR(25) NOT NULL CHECK (type IN ('VISITOR_TYPE_ADULT',
                                                              'VISITOR_TYPE_CHILD')),
    first_name          NVARCHAR(100) NOT NULL,
    last_name           NVARCHAR(100) NOT NULL,
    birth_date          DATE NOT NULL,
    sex_type            NVARCHAR(30) NOT NULL CHECK (sex_type IN ('SEX_TYPE_MALE',
                                                                  'SEX_TYPE_FEMALE',
                                                                  'SEX_TYPE_OTHER')),
